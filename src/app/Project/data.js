...
export const projects = [
  {
    ...
    tech: ["View engine:Handlebar", "ExpressJS of NodeJS", "MongoDB", "Restful API"],
    link: "https://edusocial.onrender.com/",
    image: Edu_Social
  },
  {
    title: "WEB ELECTRONIC NEWSPAPER MANAGEMENT WEBSITE",
    description: "Developed an electronic newspaper management website with a professional role-based system, optimizing the publishing process. Admin oversees the entire system, Editor reviews and edits articles, Writer creates high-quality content, and User enjoys a seamless reading experience",
    tech: ["View engine:EJS", "ExpressJS of NodeJS", "MySQL", "Restful API"],
    link: "https://baodientu3-host.onrender.com/",
  ...
  },
  {
    ...
    tech: ["ReactJS", "NestJS of NodeJS", "PostgreSQL", "GraphQL API", "JWT"],
